                            ...
                            <div class="product-item-wrap row">
                                    ...
                                    <div class="product-item">
                                        <div class="product-img">
                                            <a href="{{ asset('catalog')}}">
                                                <img class="primary-img" src="{{asset('images/product/medium-size/1-1-270x300.jpg')}}" alt="Product Images">
                                                <img class="secondary-img" src="{{asset('images/product/medium-size/1-2-270x300.jpg')}}" alt="Product Images">
                                            </a>
                                            <div class="product-add-action">
                                                <ul>
                                                    ...
                                                    <li>
                                                        <a href="{{ asset('cart')}}" data-tippy="Add to cart" data-tippy-inertia="true" data-tippy-animation="shift-away" data-tippy-delay="50" data-tippy-arrow="true" data-tippy-theme="sharpborder">
                                        ...
                                        <div class="product-content">
                                            <a class="product-name" href="{{ asset('catalog')}}">American Marigold</a>
                                ...
                                <div class="col-xl-3 col-md-4 col-sm-6">
                                    <div class="product-item">
                                        ...
                                        <div class="product-content">
                                            <a class="product-name" href="{{ asset('catalog')}}">Black Eyed Susan</a>
                                            <div class="price-box pb-1">
                                ...
                                <div class="col-xl-3 col-md-4 col-sm-6">
                                    <div class="product-item">
                                        ...
                                        <div class="product-content">
                                            <a class="product-name" href="{{ asset('catalog')}}">Bleeding Heart</a>
                                            <div class="price-box pb-1">
                                ...
                                <div class="col-xl-3 col-md-4 col-sm-6">
                                    <div class="product-item">
                                        ...
                                        <div class="product-content">
                                            <a class="product-name" href="{{ asset('catalog')}}">Bloody Cranesbill</a>
                                            <div class="price-box pb-1">
                                ...
                                <div class="col-xl-3 col-md-4 col-sm-6 pt-4">
                                    <div class="product-item">
                                        ...
                                        <div class="product-content">
                                            <a class="product-name" href="{{ asset('catalog')}}">Butterfly Weed</a>
                                            <div class="price-box pb-1">
                                ...
                                <div class="col-xl-3 col-md-4 col-sm-6 pt-4">
                                    <div class="product-item">
                                        ...
                                        <div class="product-content">
                                            <a class="product-name" href="{{ asset('catalog')}}">Common Yarrow</a>
                                            <div class="price-box pb-1">
                                ...
                                <div class="col-xl-3 col-md-4 col-sm-6 pt-4">
                                    <div class="product-item">
                                        ...
                                        <div class="product-content">
                                            <a class="product-name" href="{{ asset('catalog')}}">Doublefile Viburnum</a>
                                            <div class="price-box pb-1">
                                ...
                                <div class="col-xl-3 col-md-4 col-sm-6 pt-4">
                                    <div class="product-item">
                                        ...
                                        <div class="product-content">
                                            <a class="product-name" href="{{ asset('catalog')}}">Feather Reed Grass</a>
                                            <div class="price-box pb-1">
