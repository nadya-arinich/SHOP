...
<div class="main-wrapper">
                                ...
                                <ul>
                                    <li class="dropdown d-none d-lg-block">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="settingButton">
                                            <li><a class="dropdown-item" href="{{ asset('register')}}">Рестрация</a></li>
                                            <li><a class="dropdown-item" href="{{ asset('login')}}">Авторизация</a>
                    ...
                    <ul class="minicart-list">
                        <li class="minicart-product">
                            ...
                            <a href="single-product-variable.html" class="product-item_img">
                                <img class="img-full" src="{{asset('images/product/small-size/2-1-70x78.png')}}" alt="Product Image">
                            </a>
                        ...
                        <li class="minicart-product">
                            <a class="product-item_remove" href="#"><i class="pe-7s-close" data-tippy="Remove"
                                                                       ...
                                                                       data-tippy-arrow="true" data-tippy-theme="sharpborder"></i></a>
                            <a href="single-product-variable.html" class="product-item_img">
                                <img class="img-full" src="{{asset('images/product/small-size/2-2-70x78.png')}}" alt="Product Image">
                            </a>
                            <div class="product-item_content">
                        ...
                        <li class="minicart-product">
                            ...
                            <a href="single-product-variable.html" class="product-item_img">
                                <img class="img-full" src="{{asset('images/product/small-size/2-3-70x78.png')}}" alt="Product Image">
                            </a>
                            <div class="product-item_content">
    ...
    <!-- Begin Footer Area -->
    <div class="footer-area" data-bg-image="{{asset('images/footer/bg/1-1920x465.jpg')}}">
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <a href="#" class="single-img">
                                                <img class="img-full" src="{{asset('images/product/large-size/1-1-570x633.jpg')}}" alt="Product Image">
                                            </a>
                                        </div>
                                        <div class="swiper-slide">
                                            <a href="#" class="single-img">
                                                <img class="img-full" src="{{asset('images/product/large-size/1-2-570x633.jpg')}}" alt="Product Image">
                                            </a>
                                        </div>
                                        <div class="swiper-slide">
                                            <a href="#" class="single-img">
                                                <img class="img-full" src="{{asset('images/product/large-size/1-3-570x633.jpg')}}" alt="Product Image">
                                            </a>
                                        </div>
                                        <div class="swiper-slide">
                                            <a href="#" class="single-img">
                                                <img class="img-full" src="{{asset('images/product/large-size/1-4-570x633.jpg')}}" alt="Product Image">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="single-product-content">
                                ...
                                <ul class="quantity-with-btn">
                                    ...
                                    <li class="add-to-cart">
                                        <a class="btn btn-custom-size lg-size btn-pronia-primary" href="{{asset('cart')}}">Add to
                                            cart</a>
                                    </li>
                                ...
                                <ul class="service-item-wrap pb-0">
                                    <li class="service-item">
                                        <div class="service-img">
                                            <img src="{{asset('images/shipping/icon/car.png')}}" alt="Shipping Icon">
                                        </div>
                                    ...
                                    <li class="service-item">
                                        <div class="service-img">
                                            <img src="{{asset('images/shipping/icon/card.png')}}" alt="Shipping Icon">
                                        </div>
                                        <div class="service-content">
                                    ...
                                    <li class="service-item">
                                        <div class="service-img">
                                            <img src="{{asset('images/shipping/icon/service.png')}}" alt="Shipping Icon">
                                        </div>
                                        <div class="service-content">
                                            <span class="title">Safe <br> Payment</span>
                                        </div>
